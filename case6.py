...
# Form implementation generated from reading ui file 'case6.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(10, 110, 114, 331))
        ...
        self.comboBox.setGeometry(QtCore.QRect(150, 71,100, 21))
        self.comboBox.setObjectName("comboBox")
        self.comboBox.addItem("")
        self.comboBox.addItem("")
        #self.comboBox.addItem("")
        self.pushButton_2 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_2.setGeometry(QtCore.QRect(300, 70, 91, 23))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox.setItemText(1, _translate("MainWindow", "SMART"))
        self.actionversion.setText(_translate("MainWindow", "version"))
        self.pushButton_2.setText(_translate("MainWindow", "导入文本文件"))#按钮名字
    ...
    def get_text(self):
        ...
        :return:
        """
        self.groupname = self.comboBox.currentText()
